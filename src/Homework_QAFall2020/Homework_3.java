...
public class Homework_3 {
    public static void main(String[] args) {
        ...
        System.out.println("Temperature in fahrenheit is " + fTemparature2);
        double cTemperature3 = 30.5;
        double kTemperature3 = cTemperature3 + 273;
        System.out.println("Temperature in kelvin is " + kTemperature3);
        double kTemperature4 = 303.50;
        double cTemperature4 = kTemperature4 - 273;
        System.out.println("Temperature in celsius is " + cTemperature4);
        double fTemperature5 = 90;
        double kTemperature5 = 5/9.0 * (fTemperature5 - 32) + 273;
        System.out.println("Temperature in kelvin is " + kTemperature5);
